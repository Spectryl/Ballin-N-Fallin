...
func _set(property: StringName, value: Variant) -> bool:
	if property == &"polygon":
		line_2d.points = construct_closed_line(value)
...
func update_points() -> void:
	...
	line_2d.points = construct_closed_line(polygon)
...
#Another JigglyJello comment here to say this function which is also in antialiased line is being put here
#Because GD script is doing the beautiful thing where it can't comprehend static function calls from other scripts
