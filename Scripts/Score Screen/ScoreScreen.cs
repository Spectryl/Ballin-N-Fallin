...
public partial class ScoreScreen : CanvasLayer{
	...
	private readonly PackedScene endScreenScene = GD.Load<PackedScene>("res://Scenes/Object Scenes/Score Screen/PlayerEndscreenResult.tscn");
			...
			if(Online.IsHost()){
				if(!Tour.IsTour){
					...
					if(Game.AutoStartNewTour){
						...
						AddChild(GD.Load<PackedScene>("res://Scenes/Object Scenes/Menus/ScoreScreenMenu.tscn").Instantiate<ScoreScreenMenu>());
					}
				}else{
