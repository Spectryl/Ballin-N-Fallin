...
public partial class Race : Mode, ILevelLoadedEvent{
	...
	public override void _Ready(){
        ...
        TopCheckPoint = 0;
        AddChild(GD.Load<PackedScene>("res://Scenes/Object Scenes/Mode Stuff/Race/Countdown.tscn").Instantiate());

        //Time Trials
        if(Game.TotalPlayers == 1){
            AddChild(GD.Load<PackedScene>("res://Scenes/Object Scenes/Mode Stuff/Race/RaceHUD.tscn").Instantiate());
