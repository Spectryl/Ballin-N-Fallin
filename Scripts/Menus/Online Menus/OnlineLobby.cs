...
public partial class OnlineLobby : Node{
	...
	public override void _Ready(){
		...
		mainMenu = GD.Load<PackedScene>("res://Scenes/Object Scenes/Menus/MainMenu.tscn");
		...
		PackedScene playerTextScene = GD.Load<PackedScene>("res://Scenes/Object Scenes/Menus/Online/OnlinePlayerText.tscn");
    ...
    private void HostLobby(){
		...
		switch(Online.Network){
			...
			case Online.NetworkType.Steam:
				Node steamSetupNode = GD.Load<PackedScene>("res://Scenes/Object Scenes/Menus/Online/SteamMultiplayerPeerSetup.tscn").Instantiate();
	...
	public void JoinedLobby(){
		AddChild(GD.Load<PackedScene>("res://Scenes/Object Scenes/Menus/Online/LobbySettingsMenu.tscn").Instantiate<LobbySettingsMenu>());
	...
	private void CreatePingGetter(){
		if(Game.GameNode.GetNodeOrNull("PingGetter") == null){
			PingGetter pingNode = GD.Load<PackedScene>("res://Scenes/Object Scenes/Menus/Online/PingGetter.tscn").Instantiate<PingGetter>();
